...
{
    /// <summary>
    /// 问题：图片是以“后滑板右羊角Y值”的监测类型来找出来的！！！
    /// </summary>
    public partial class UD_Angle : Form
    {
        public UD_Angle(Index owner, DateTime time, string device_name, string station_name, bool direction, string train_no, int point_type_id, bool frontOrBack)
        {
            InitializeComponent();
            this.time = time;
        ...
        private void FB_Angle_Load(object sender, EventArgs e)
        {
            ...
            if (current < morning || current >= nightfall)//判断是白天还是晚上（晚上）
            {
                try
                {
                    DataTable dt = MergeQuery.GetDataBefore("v_data_log", "top 2 data_value,picturepath,flash_time,status_type_name", "flash_time", time, "and device_name ='" + device_name + "' and train_no ='" + train_no + "'  and direction ='" + direction + "' and (convert(varchar(8),flash_time,114) between '" + night1 + "'and'24:00:00' or convert(varchar(8),flash_time,114) between '00:00:00'and'" + night2 + "') and point_type_id=" + point_type_id + " and (status_type_name<>'警示' and status_type_name<>'疑似报警') and point_type_name='前滑板左羊角X值'", "order by flash_time DESC", null);
                    ...
                    dt = MergeQuery.GetDataBefore("v_data_log", "top 2 data_value,picturepath,flash_time,status_type_name", "flash_time", time, "and device_name ='" + device_name + "' and train_no ='" + train_no + "'  and direction ='" + direction + "' and (convert(varchar(8),flash_time,114) between '" + night1 + "'and'24:00:00' or convert(varchar(8),flash_time,114) between '00:00:00'and'" + night2 + "') and point_type_id=" + point_type_id + " and (status_type_name<>'警示' and status_type_name<>'疑似报警') and point_type_name='前滑板左羊角Y值'", "order by flash_time DESC", null);
                    ...
                    dt = MergeQuery.GetDataBefore("v_data_log", "top 2 data_value,picturepath,flash_time,status_type_name", "flash_time", time, "and device_name ='" + device_name + "' and train_no ='" + train_no + "'  and direction ='" + direction + "' and (convert(varchar(8),flash_time,114) between '" + night1 + "'and'24:00:00' or convert(varchar(8),flash_time,114) between '00:00:00'and'" + night2 + "') and point_type_id=" + point_type_id + " and (status_type_name<>'警示' and status_type_name<>'疑似报警') and point_type_name='前滑板右羊角X值'", "order by flash_time DESC", null);
                    ...
                    dt = MergeQuery.GetDataBefore("v_data_log", "top 2 data_value,picturepath,flash_time,status_type_name", "flash_time", time, "and device_name ='" + device_name + "' and train_no ='" + train_no + "'  and direction ='" + direction + "' and (convert(varchar(8),flash_time,114) between '" + night1 + "'and'24:00:00' or convert(varchar(8),flash_time,114) between '00:00:00'and'" + night2 + "') and point_type_id=" + point_type_id + " and (status_type_name<>'警示' and status_type_name<>'疑似报警') and point_type_name='前滑板右羊角Y值'", "flash_time DESC", null);
                    ...
                    dt = MergeQuery.GetDataBefore("v_data_log", "top 2 data_value,picturepath,flash_time,status_type_name", "flash_time", time, "and device_name ='" + device_name + "' and train_no ='" + train_no + "'  and direction ='" + direction + "' and (convert(varchar(8),flash_time,114) between '" + night1 + "'and'24:00:00' or convert(varchar(8),flash_time,114) between '00:00:00'and'" + night2 + "') and point_type_id=" + point_type_id + " and (status_type_name<>'警示' and status_type_name<>'疑似报警') and point_type_name='后滑板左羊角X值'", "order by flash_time DESC", null);
                    ...
                    dt = MergeQuery.GetDataBefore("v_data_log", "top 2 data_value,picturepath,flash_time,status_type_name", "flash_time", time, "and device_name ='" + device_name + "' and train_no ='" + train_no + "'  and direction ='" + direction + "' and (convert(varchar(8),flash_time,114) between '" + night1 + "'and'24:00:00' or convert(varchar(8),flash_time,114) between '00:00:00'and'" + night2 + "') and point_type_id=" + point_type_id + " and (status_type_name<>'警示' and status_type_name<>'疑似报警') and point_type_name='后滑板左羊角Y值'", "order by flash_time DESC", null);
                    ...
                    dt = MergeQuery.GetDataBefore("v_data_log", "top 2 data_value,picturepath,flash_time,status_type_name", "flash_time", time, "and device_name ='" + device_name + "' and train_no ='" + train_no + "'  and direction ='" + direction + "' and (convert(varchar(8),flash_time,114) between '" + night1 + "'and'24:00:00' or convert(varchar(8),flash_time,114) between '00:00:00'and'" + night2 + "') and point_type_id=" + point_type_id + " and (status_type_name<>'警示' and status_type_name<>'疑似报警') and point_type_name='后滑板右羊角X值'", "order by flash_time DESC", null);
                    ...
                    dt = MergeQuery.GetDataBefore("v_data_log", "top 2 data_value,picturepath,flash_time,status_type_name", "flash_time", time, "and device_name ='" + device_name + "' and train_no ='" + train_no + "'  and direction ='" + direction + "' and (convert(varchar(8),flash_time,114) between '" + night1 + "'and'24:00:00' or convert(varchar(8),flash_time,114) between '00:00:00'and'" + night2 + "') and point_type_id=" + point_type_id + " and (status_type_name<>'警示' and status_type_name<>'疑似报警') and point_type_name='后滑板右羊角Y值'", "order by flash_time DESC", null);
            ...
            else//白天
            {
                try
                {
                    DataTable dt = MergeQuery.GetDataBefore("v_data_log", "top 2 filepath,flash_time", "flash_time", time, "and device_name ='" + device_name + "' and train_no ='" + train_no + "'  and direction ='" + direction + "' and (convert(varchar(8),flash_time,114) between '" + day + "'and'" + night1 + "') and (status_type_name<>'警示' and status_type_name<>'疑似报警')", "order by flash_time DESC", null);
                    ...
                    label4.Text = "上次行车时间：" + time2;
                    label5.Text = "本次行车时间：" + time;
                    label1.Text = "列车号：" + train_no + "车厢号：" + device_name + " 受电弓影像对比";
