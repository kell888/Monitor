...
namespace MergeQueryUtil
{
    ...
    public static class MergeCommon
    {
        ...
        /// <returns></returns>
        public static DataTable GetTableSchama(string tablename, string connConfig = null)
        {
            using (SqlHelper sqlHelper = new SqlHelper(connConfig))
            {
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static DataTable GetTableSchama(string tablename, string yyyyMMORyyyyMMdd, string connConfig = null)
        {
            using (SqlHelper sqlHelper = new SqlHelper(connConfig))
            {
        ...
        /// <param name="connConfig"></param>
        public static void GetHistoryTime(string tablename, string timeField, out DateTime start, out DateTime end, string connConfig = null)
        {
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static DateTime GetStartTime(string tablename, string timeField, string connConfig = null)
        {
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static DateTime GetEndTime(string tablename, string timeField, string connConfig = null)
        {
            if (tablename.ToLower().StartsWith("dbo."))
                tablename = tablename.Substring(4);
            using (SqlHelper sqlHelper = new SqlHelper(connConfig))
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static bool ExistsTable(string tablename, string connConfig = null)
        {
            if (tablename.ToLower().StartsWith("dbo."))
                tablename = tablename.Substring(4);
            using (SqlHelper sqlHelper = new SqlHelper(connConfig))
            {
                DateTime end = DateTime.Now;
                object obj = sqlHelper.ExecuteScalar("select ISNULL(OBJECT_ID('" + tablename + "'),'0')");
    ...
    public static class MergeSQLQuery
    {
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static string GetQuerySQL(string tablenames, string selectFields, string timeField, string where = null, string connConfig = null)
        {
            DateTime start;
            DateTime end;
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static string GetQuerySQL_DayLog(string tablenames, string selectFields, string timeField, string where = null, string connConfig = null)
        {
            DateTime start;
            DateTime end;
            MergeCommon.GetHistoryTime(tablenames.Split(',')[0].Trim(), timeField, out start, out end, connConfig);
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static string GetQuerySQLAt(string tablenames, string selectFields, string timeField, DateTime time, string where = null, string orderby = null, string connConfig = null)
        {
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static string GetQuerySQLAt_DayLog(string tablenames, string selectFields, string timeField, DateTime time, string where = null, string orderby = null, string connConfig = null)
        {
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static string GetQuerySQLRange(string tablenames, string selectFields, string timeField, DateTime start, DateTime end, string where = null, string connConfig = null)
        {
            int yearOffset = end.Year - start.Year;
            if (yearOffset > 0)
            {
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static string GetQuerySQLRange_DayLog(string tablenames, string selectFields, string timeField, DateTime start, DateTime end, string where = null, string connConfig = null)
        {
            int yearOffset = end.Year - start.Year;
            if (yearOffset > 0)
            {
        ...
        private static string GetSQL(string tablenames, string selectFields, string timeField, string yyyyMM, string s, string e, string where = null, string connConfig = null)
        {
            string tables = "";
            string[] ts = tablenames.Split(',');
            foreach (string table in ts)
            ...
            string logSql = ConfigurationManager.AppSettings["logSql"];
            if (!string.IsNullOrEmpty(logSql) && logSql == "1")
                Logs.Trace("GetSQL:" + sql);
            return sql;
        }
        private static string GetSQL_DayLog(string tablenames, string selectFields, string timeField, string yyyyMMdd, string s, string e, string where = null, string connConfig = null)
        {
            string tables = "";
            string[] ts = tablenames.Split(',');
            foreach (string table in ts)
        ...
        private static string MultiYear(string tablenames, string selectFields, string timeField, DateTime start, DateTime end, string where = null, string connConfig = null)
        {
            string dt = "";
        ...
        private static string SingleYear(string tablenames, string selectFields, string timeField, DateTime start, DateTime end, string where = null, string connConfig = null)
        {
            string dt = "";
        ...
        private static string SingleMonth(string tablenames, string selectFields, string timeField, int year, int month, int startDay, int endDay, string startTime, string endTime, string where = null, string connConfig = null)
        {
        ...
        private static string SingleDay(string tablenames, string selectFields, string timeField, int year, int month, int day, string startTime, string endTime, string where = null, string connConfig = null)
        {
    ...
    public static class MergeSQLUpdate
    {
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static string GetUpdateSQL(string tablenames, string updateFields, string timeField, string where = null, string connConfig = null)
        {
            DateTime start;
            DateTime end;
            MergeCommon.GetHistoryTime(tablenames.Split(',')[0].Trim(), timeField, out start, out end, connConfig);
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static string GetUpdateSQL_DayLog(string tablenames, string updateFields, string timeField, string where = null, string connConfig = null)
        {
            DateTime start;
            DateTime end;
            MergeCommon.GetHistoryTime(tablenames.Split(',')[0].Trim(), timeField, out start, out end, connConfig);
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static string GetUpdateSQL(string tablenames, string updateFields, string timeField, DateTime time, string where = null, string connConfig = null)
        {
            string yyyyMM = MergeCommon.GetYYYYMM(time);
            string tables = "";
            string[] ts = tablenames.Split(',');
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static string GetUpdateSQL_DayLog(string tablenames, string updateFields, string timeField, DateTime time, string where = null, string connConfig = null)
        {
            string yyyyMMdd = MergeCommon.GetYYYYMMDD(time);
            string tables = "";
            string[] ts = tablenames.Split(',');
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static string GetUpdateSQL(string tablenames, string updateFields, string timeField, DateTime start, DateTime end, string where = null, string connConfig = null)
        {
            int yearOffset = end.Year - start.Year;
            if (yearOffset > 0)
            {
        ...
        private static string GetSQL(string tablenames, string updateFields, string timeField, string yyyyMM, string s, string e, string where = null, string connConfig = null)
        {
            string tables = "";
            string[] ts = tablenames.Split(',');
            foreach (string table in ts)
        ...
        private static string GetSQL_DayLog(string tablenames, string updateFields, string timeField, string yyyyMMdd, string s, string e, string where = null, string connConfig = null)
        {
            string tables = "";
            string[] ts = tablenames.Split(',');
            foreach (string table in ts)
        ...
        private static string MultiYear(string tablenames, string updateFields, string timeField, DateTime start, DateTime end, string where = null, string connConfig = null)
        {
            string dt = "";
            int startYear = start.Year;
            int endYear = end.Year;
        ...
        private static string SingleYear(string tablenames, string updateFields, string timeField, DateTime start, DateTime end, string where = null, string connConfig = null)
        {
            string dt = "";
            int startMonth = start.Month;
            int endMonth = end.Month;
        ...
        private static string SingleMonth(string tablenames, string updateFields, string timeField, int year, int month, int startDay, int endDay, string startTime, string endTime, string where = null, string connConfig = null)
        {
            string yyyyMM = year.ToString().PadLeft(4, '0') + month.ToString().PadLeft(2, '0');
            string s = yyyyMM.Substring(0, 4) + "-" + yyyyMM.Substring(4, 2) + "-" + startDay.ToString().PadLeft(2, '0') + " " + startTime;
            string e = yyyyMM.Substring(0, 4) + "-" + yyyyMM.Substring(4, 2) + "-" + endDay.ToString().PadLeft(2, '0') + " " + endTime;
        ...
        private static string SingleDay(string tablenames, string updateFields, string timeField, int year, int month, int day, string startTime, string endTime, string where = null, string connConfig = null)
        {
            string yyyyMMdd = year.ToString().PadLeft(4, '0') + month.ToString().PadLeft(2, '0') + day.ToString().PadLeft(2, '0');
            string s = yyyyMMdd.Substring(0, 4) + "-" + yyyyMMdd.Substring(4, 2) + "-" + yyyyMMdd.Substring(6, 2) + " " + startTime;
            string e = yyyyMMdd.Substring(0, 4) + "-" + yyyyMMdd.Substring(4, 2) + "-" + yyyyMMdd.Substring(6, 2) + " " + endTime;
    ...
    public static class MergeQuery
    {
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static DataTable GetData(string tablenames, string selectFields, string timeField, string where = null, string orderby = null, string connConfig = null)
        {
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static DataTable GetData_DayLog(string tablenames, string selectFields, string timeField, string where = null, string orderby = null, string connConfig = null)
        {
            DataTable dt = new DataTable("NULL");
            DateTime start;
            DateTime end;
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static DataTable GetDataRange(string tablenames, string selectFields, string timeField, DateTime start, DateTime end, string where = null, string orderby = null, string connConfig = null)
        {
            DataTable dt = new DataTable("NULL");
            int yearOffset = end.Year - start.Year;
            if (yearOffset > 0)
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static DataTable GetDataRange_DayLog(string tablenames, string selectFields, string timeField, DateTime start, DateTime end, string where = null, string orderby = null, string connConfig = null)
        {
            DataTable dt = new DataTable("NULL");
            int yearOffset = end.Year - start.Year;
            if (yearOffset > 0)
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static DataTable GetDataAfter(string tablenames, string selectFields, string timeField, DateTime start, string where = null, string orderby = null, string connConfig = null)
        {
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static DataTable GetDataAfter_DayLog(string tablenames, string selectFields, string timeField, DateTime start, string where = null, string orderby = null, string connConfig = null)
        {
            DateTime end = MergeCommon.GetEndTime(tablenames.Split(',')[0].Trim(), timeField, connConfig);
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static DataTable GetDataBefore(string tablenames, string selectFields, string timeField, DateTime end, string where = null, string orderby = null, string connConfig = null)
        {
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static DataTable GetDataBefore_DayLog(string tablenames, string selectFields, string timeField, DateTime end, string where = null, string orderby = null, string connConfig = null)
        {
            DateTime start = MergeCommon.GetStartTime(tablenames.Split(',')[0].Trim(), timeField, connConfig);
            return GetDataRange_DayLog(tablenames, selectFields, timeField, start, end, where, orderby, connConfig);
        }
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static DataTable GetDataCurrentMonth(string tablenames, string selectFields, string timeField, string where = null, string orderby = null, string connConfig = null)
        {
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static DataTable GetDataCurrentMonth_DayLog(string tablenames, string selectFields, string timeField, string where = null, string orderby = null, string connConfig = null)
        {
        ...
        private static DataTable MultiYear(string tablenames, string selectFields, string timeField, DateTime start, DateTime end, string where = null, string orderby = null, string connConfig = null)
        {
            DataTable dt = new DataTable("NULL");
            int startYear = start.Year;
            int endYear = end.Year;
        ...
        private static DataTable SingleYear(string tablenames, string selectFields, string timeField, DateTime start, DateTime end, string where = null, string orderby = null, string connConfig = null)
        {
            DataTable dt = new DataTable("NULL");
            int startMonth = start.Month;
            int endMonth = end.Month;
        ...
        private static DataTable SingleMonth(string tablenames, string selectFields, string timeField, int year, int month, int startDay, int endDay, string startTime, string endTime, string where = null, string orderby = null, string connConfig = null)
        {
            string yyyyMM = year.ToString().PadLeft(4, '0') + month.ToString().PadLeft(2, '0');
            string s = yyyyMM.Substring(0, 4) + "-" + yyyyMM.Substring(4, 2) + "-" + startDay.ToString().PadLeft(2, '0') + " " + startTime;
            string e = yyyyMM.Substring(0, 4) + "-" + yyyyMM.Substring(4, 2) + "-" + endDay.ToString().PadLeft(2, '0') + " " + endTime;
        ...
        private static DataTable SingleDay(string tablenames, string selectFields, string timeField, int year, int month, int day, string startTime, string endTime, string where = null, string orderby = null, string connConfig = null)
        {
            string yyyyMMdd = year.ToString().PadLeft(4, '0') + month.ToString().PadLeft(2, '0') + day.ToString().PadLeft(2, '0');
        ...
        private static DataTable GetTable(string tablenames, string selectFields, string timeField, string yyyyMM, string s, string e, string where = null, string orderby = null, string connConfig = null)
        {
            using (SqlHelper sqlHelper = new SqlHelper(connConfig))
            {
                string tables = "";
        ...
        private static DataTable GetTable_DayLog(string tablenames, string selectFields, string timeField, string yyyyMMdd, string s, string e, string where = null, string orderby = null, string connConfig = null)
        {
            using (SqlHelper sqlHelper = new SqlHelper(connConfig))
            {
                string tables = "";
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static DataTable GetDataAt(string tablenames, string selectFields, string timeField, DateTime time, string where = null, string orderby = null, string connConfig = null)
        {
            using (SqlHelper sqlHelper = new SqlHelper(connConfig))
            {
                string yyyyMM = MergeCommon.GetYYYYMM(time);
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static DataTable GetDataAt_DayLog(string tablenames, string selectFields, string timeField, DateTime time, string where = null, string orderby = null, string connConfig = null)
        {
            using (SqlHelper sqlHelper = new SqlHelper(connConfig))
            {
                string yyyyMMdd = MergeCommon.GetYYYYMMDD(time);
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static SqlDataAdapter GetAdapterAt(string tablenames, string selectFields, string timeField, DateTime time, string where = null, string orderby = null, string connConfig = null)
        {
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static SqlDataAdapter GetAdapterAt_DayLog(string tablenames, string selectFields, string timeField, DateTime time, string where = null, string orderby = null, string connConfig = null)
        {
            SqlHelper sqlHelper = new SqlHelper(connConfig);
            string yyyyMMdd = MergeCommon.GetYYYYMMDD(time);
            string tables = "";
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static SqlDataAdapter GetAdapter(string tablenames, string selectFields, string timeField, string where = null, string orderby = null, string connConfig = null)
        {
            SqlHelper sqlHelper = new SqlHelper(connConfig);
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static SqlDataAdapter GetAdapter_DayLog(string tablenames, string selectFields, string timeField, string where = null, string orderby = null, string connConfig = null)
        {
            SqlHelper sqlHelper = new SqlHelper(connConfig);
            DateTime theMonthStart;
            DateTime theMonthEnd;
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static SqlDataAdapter GetAdapterRange(string tablenames, string selectFields, string timeField, DateTime theMonthStart, DateTime theMonthEnd, string where = null, string orderby = null, string connConfig = null)
        {
            SqlHelper sqlHelper = new SqlHelper(connConfig);
            string yyyyMM = MergeCommon.GetYYYYMM(theMonthStart);
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static SqlDataAdapter GetAdapterRange_DayLog(string tablenames, string selectFields, string timeField, DateTime theMonthStart, DateTime theMonthEnd, string where = null, string orderby = null, string connConfig = null)
        {
            SqlHelper sqlHelper = new SqlHelper(connConfig);
            string yyyyMMdd = MergeCommon.GetYYYYMMDD(theMonthStart);
            theMonthEnd = theMonthEnd.AddSeconds(1);
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static SqlDataAdapter GetAdapterCurrentMonth(string tablenames, string selectFields, string timeField, string where = null, string orderby = null, string connConfig = null)
        {
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static SqlDataAdapter GetAdapterCurrentMonth_DayLog(string tablenames, string selectFields, string timeField, string where = null, string orderby = null, string connConfig = null)
        {
    ...
    public static class MergeUpdate
    {
        ...
        /// <param name="where"></param>
        /// <param name="connConfig"></param>
        public static void UpdateData(string tablenames, string updateFields, string timeField, string where = null, string connConfig = null)
        {
            DateTime start;
            DateTime end;
            MergeCommon.GetHistoryTime(tablenames.Split(',')[0].Trim(), timeField, out start, out end, connConfig);
        ...
        /// <param name="where"></param>
        /// <param name="connConfig"></param>
        public static void UpdateData_DayLog(string tablenames, string updateFields, string timeField, string where = null, string connConfig = null)
        {
            DateTime start;
            DateTime end;
            MergeCommon.GetHistoryTime(tablenames.Split(',')[0].Trim(), timeField, out start, out end, connConfig);
        ...
        /// <param name="where"></param>
        /// <param name="connConfig"></param>
        public static void UpdateData(string tablenames, string updateFields, string timeField, DateTime start, DateTime end, string where = null, string connConfig = null)
        {
            int yearOffset = end.Year - start.Year;
            if (yearOffset > 0)
            {
        ...
        /// <param name="where"></param>
        /// <param name="connConfig"></param>
        public static void UpdateData_DayLog(string tablenames, string updateFields, string timeField, DateTime start, DateTime end, string where = null, string connConfig = null)
        {
            int yearOffset = end.Year - start.Year;
            if (yearOffset > 0)
            {
        ...
        private static void MultiYear(string tablenames, string selectFields, string timeField, DateTime start, DateTime end, string where = null, string connConfig = null)
        {
            int startYear = start.Year;
            int endYear = end.Year;
        ...
        private static void SingleYear(string tablenames, string selectFields, string timeField, DateTime start, DateTime end, string where = null, string connConfig = null)
        {
            int startMonth = start.Month;
            int endMonth = end.Month;
            int year = start.Year;
        ...
        private static bool SingleMonth(string tablenames, string selectFields, string timeField, int year, int month, int startDay, int endDay, string startTime, string endTime, string where = null, string connConfig = null)
        {
            string yyyyMM = year.ToString().PadLeft(4, '0') + month.ToString().PadLeft(2, '0');
            string s = yyyyMM.Substring(0, 4) + "-" + yyyyMM.Substring(4, 2) + "-" + startDay.ToString().PadLeft(2, '0') + " " + startTime;
            string e = yyyyMM.Substring(0, 4) + "-" + yyyyMM.Substring(4, 2) + "-" + endDay.ToString().PadLeft(2, '0') + " " + endTime;
        ...
        private static bool SingleDay(string tablenames, string selectFields, string timeField, int year, int month, int day, string startTime, string endTime, string where = null, string connConfig = null)
        {
            string yyyyMMdd = year.ToString().PadLeft(4, '0') + month.ToString().PadLeft(2, '0') + day.ToString().PadLeft(2, '0');
            string s = yyyyMMdd.Substring(0, 4) + "-" + yyyyMMdd.Substring(4, 2) + "-" + yyyyMMdd.Substring(6, 2) + " " + startTime;
            string e = yyyyMMdd.Substring(0, 4) + "-" + yyyyMMdd.Substring(4, 2) + "-" + yyyyMMdd.Substring(6, 2) + " " + endTime;
        ...
        private static bool Update(string tablenames, string updateFields, string timeField, string yyyyMM, string s, string e, string where = null, string connConfig = null)
        {
            using (SqlHelper sqlHelper = new SqlHelper(connConfig))
            {
                string tables = "";
        ...
        private static bool Update_DayLog(string tablenames, string updateFields, string timeField, string yyyyMMdd, string s, string e, string where = null, string connConfig = null)
        {
            using (SqlHelper sqlHelper = new SqlHelper(connConfig))
            {
                string tables = "";
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static bool UpdateData(string tablenames, string updateFields, string timeField, DateTime time, string where = null, string connConfig = null)
        {
            using (SqlHelper sqlHelper = new SqlHelper(connConfig))
            {
                string yyyyMM = MergeCommon.GetYYYYMM(time);
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static bool UpdateData_DayLog(string tablenames, string updateFields, string timeField, DateTime time, string where = null, string connConfig = null)
        {
            using (SqlHelper sqlHelper = new SqlHelper(connConfig))
            {
                string yyyyMMdd = MergeCommon.GetYYYYMMDD(time);
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static bool UpdateData(string tablenames, string updateFields, string idField, string id, string yyyyMM, string connConfig = null)
        {
            using (SqlHelper sqlHelper = new SqlHelper(connConfig))
            {
                string tables = "";
        ...
        /// <param name="connConfig"></param>
        /// <returns></returns>
        public static bool UpdateData_DayLog(string tablenames, string updateFields, string idField, string id, string yyyyMMdd, string connConfig = null)
        {
            using (SqlHelper sqlHelper = new SqlHelper(connConfig))
            {
                string tables = "";
